...
| ensure catalog | `action.EnsureCatalog` | (inside update-prices) | (inside update prices; Confirm nil = declines) | downloading catalog (d, bytes) | build?/refresh? | usable bool | — | migrated |
