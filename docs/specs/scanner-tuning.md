...
| 0.1s | 4 | 3 | 1,536ms | 12% | n/a | shortening the streak bought almost nothing |
...
Real separation, **one negative sample**. So `placementFaceFloor = 25.0` is
...
This is the reason the text-anchored table exists at all. Measuring through
