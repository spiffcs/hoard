...
func TestCmdReportText(t *testing.T) {
	...
	if err := cmdReport(st, []string{"-o", out}, false); err != nil {
...
func TestCmdReportJSON(t *testing.T) {
	...
	if err := cmdReport(st, []string{"-o", out}, true); err != nil {
		t.Fatalf("cmdReport: %v", err)
	}
...
func TestCmdReportCSV(t *testing.T) {
	...
	if err := cmdReport(st, []string{"--csv", "-o", out}, false); err != nil {
		t.Fatalf("cmdReport: %v", err)
	}
...
func TestCmdReportRejectsCSVWithJSON(t *testing.T) {
	st := exportStore(t)
	if err := cmdReport(st, []string{"--csv"}, true); err == nil {
		t.Error("cmdReport(--csv, --json) succeeded, want an error")
	}
}
